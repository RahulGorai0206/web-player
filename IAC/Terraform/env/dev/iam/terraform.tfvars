...
service_account_configs = {
  dev-github-oauth-sa = {
    ...
    project_level_roles  = ["roles/artifactregistry.admin", "roles/iam.serviceAccountAdmin", "roles/storage.objectAdmin", "roles/iam.serviceAccountTokenCreator", "roles/run.admin", "roles/viewer"]
  },
  dev-cloud-run-sa = {
